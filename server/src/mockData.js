...
export function buildRecipe({ cut = 'אסאדו מעושן', method = 'מעשנה', effort = 'מאוזן', kosherPreference = 'כשר', seasoningStyle = 'קלאסי' } = {}) {
  ...
  const sauceSets = [
    ...
    [
      ...
      { title: 'רוטב פלפלים קלויים', description: 'רוטב מתקתק-חרוך שמתאים לגריל פחמים ומנגל ישראלי.', ingredients: ['2 פלפלים קלויים', 'שן שום', '2 כפות שמן זית', 'כפית חומץ', 'מלח גס'], steps: ['קולפים פלפלים קלויים.', 'טוחנים עם שום, שמן וחומץ.', 'מתבלים ומגישים לצד פרוסות הבשר.'] },
    ],
    [
  ...
  return {
    ...
    ingredients: [
      `${cleanCut} - ${portionForCut(cleanCut)}`,
