...
const cutCategories: CutCategory[] = [
  {
    ...
    cuts: [
      ...
      },
      {
        ...
        bestFor: 'מנגל פחמים, פיתה, טחינה וירוקים',
      },
    ],
  },
  {
    ...
    cuts: [
      ...
      },
      {
        ...
        bestFor: 'מנגל פחמים, שיפודים, פלנצ׳ה',
      },
      {
        name: 'חזה עוף',
